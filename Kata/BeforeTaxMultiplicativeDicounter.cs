...
namespace Kata
{
    public class BeforeTaxMultiplicativeDicounter : IBeforeTaxDiscount
    {
        private BeforeTaxDefaultDiscounter _beforeDefault;
        private BeforeTaxUPCDiscounter _beforeUPC;
        public BeforeTaxMultiplicativeDicounter(List<DiscountDetails> listOfDiscounts)
        {
        ...
        public double CalculateDiscountsBefore(Product product,double price)
        {
            ...
            if (_beforeUPC != null)
                upcAmount = _beforeUPC.CalculateDiscountsBefore(product,price-defaultAmount);
